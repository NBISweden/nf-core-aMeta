...
my_fontsize <- function(ku_abundance) {
  if (dim(ku_abundance)[1] < 50) {
    return(12)
  } else if (dim(ku_abundance)[1] >= 50 & dim(ku_abundance)[1] < 100) {
    return(10)
  } else if (dim(ku_abundance)[1] >= 100 & dim(ku_abundance)[1] < 150) {
    return(8)
  } else {
    return(6)
  }
...
if (dim(ku_abundance)[1] > 1 & dim(ku_abundance)[2] > 1) {
  pheatmap(ku_abundance,
    display_numbers = TRUE, fontsize = my_fontsize(ku_abundance),
