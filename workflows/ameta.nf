...
workflow AMETA {
    ...
    KRAKENUNIQ_FILTER.out.species_tax_id
        .ifEmpty { log.warn "[NBISweden/nf-core-aMeta] No microbes passed the KrakenUniq filter thresholds (n_unique_kmers=${params.n_unique_kmers}, n_tax_reads=${params.n_tax_reads}). Downstream analyses will be skipped." }
